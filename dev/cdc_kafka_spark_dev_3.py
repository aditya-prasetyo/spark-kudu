...
#         try:
#             estimated_count = batch_df.rdd.countApprox(1000, 0.95).getFinalValue()
#             print(" Number of records (estimated): " + str(estimated_count))
#         except:
#             print(" Could not estimate record count.")

#         try:
#             batch_df.select(
#                 "ID_numeric", "FIRST_NAME", "LAST_NAME", "EMAIL", "PHONE",
#                 "CREATED_AT", "__op", "__table", "__source_ts_ms", "__deleted"
#             ).write \
#                 .format("kudu") \
...
#                 .mode("append") \
#                 .save()
#             print(" Successfully written to Kudu.")
#         except Exception as e:
#             print(" Error writing to Kudu: " + str(e))

#         print("====================\n")
#     else:
#         print("\n Empty batch: " + str(batch_id) + "\n")
...
#         print(f" Number of records to write to Kudu: {count}")
#         batch_df.select(
#             "ID_numeric", "FIRST_NAME", "LAST_NAME", "EMAIL", "PHONE",
#             "CREATED_AT", "__op", "__table", "__source_ts_ms", "__deleted"
#         ).write \
...
#             .mode("append") \
#             .save()
#         print(f" Successfully written {count} records to Kudu.\n")
#     else:
#         print(f"\n=== Batch ID: {batch_id} ===")
